...
export const LOCATE = {
   ...
   * 자동으로 고르는 조건.
   *
   * 중요한 건 절대 점수가 아니라 2등과의 격차다. 쿨타임이 도는 중에는 숫자가 매초 바뀌고
   * 어두운 부분도 계속 줄어서 저장해둔 모습과 완전히 같을 수 없는데, 그래도 정답이
   * 1등으로 잡힌다. 절대 점수를 높게 요구하면 이런 경우를 매번 되묻게 된다.
   *
   * (실측: 저장된 모양 0.99 / 2등 0.73 → 자동, 내장 원본 0.87 / 0.76 → 격차가 좁아 되물음)
   */

  ...
  const popup = (
    <AnimatePresence>
      {open && user && (
        ...
        >
          <OverlayScrollbarsComponent style={{ maxHeight: 256 }} options={{ scrollbars: { theme: 'os-theme-maple os-theme-dark', autoHide: 'leave', autoHideDelay: 800 }, overflow: { x: 'hidden', y: 'scroll' } }}>
          {isLoading ? (
